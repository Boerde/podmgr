class Item < ActiveRecord::Base
  ...
  Paperclip.interpolates :pc_ftp_pth do |attachment, _style|
    attachment.instance.feed.ftp_path
  end

  Paperclip.interpolates :pc_ftp_url do |attachment, _style|
    attachment.instance.feed.ftp_root_url
  end

  Paperclip.interpolates :pc_ftp_host do |attachment, _style|
    attachment.instance.feed.ftp_host
  end

  def write_info_to_audio_file
    # no new file to upload -> skip
    return if audio_file.queued_for_write[:original].nil?
